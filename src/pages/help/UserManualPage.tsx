...
const roleGuides = [
  {
    ...
    can: 'Own workspace, create or monitor projects, assign AE/JE/Contractor, review dashboards, approve progress context, and monitor pilot adoption.',
    daily: 'Dashboard, Gov Dashboard, Projects, Reports, Enterprise Access, Activity Logs during pilot.',
    review: 'Project progress, pending inspections, QC/TPA issues, budget gaps, hindrances, diesel alerts, contractor uploads.',
  ...
  },
  {
    ...
    can: 'Review assigned projects, QC reports, TPA reports, progress, budget gaps, JE submissions, and contractor evidence.',
  ...
  },
  {
    ...
    can: 'Submit and verify field data, photos, GIS pins, inspections, material QC, hindrance entries, and site progress evidence.',
    daily: 'Upload Work, Inspections, GIS Map, Material Tests, Hindrance Register, TPA Portal where applicable.',
    review: 'Own pending uploads, missing GPS/photos, AI feedback, and items returned by AE/EE.',
    cannot: 'Usually should not manage workspace billing, contractor licensing, or final EE-level access setup.',
  },
  {
    role: 'Contractor',
    can: 'Upload work evidence, documents, diesel usage, material/labour/maintenance records, and TPA/supporting reports for assigned projects.',
    daily: 'Upload Work, Diesel, Materials, Labour, Maintenance, TPA Portal, project-specific reports.',
    review: 'Rejected/flagged uploads, pending evidence, diesel/material anomalies, and missing documents.',
    cannot: 'Should not see unrelated government projects or change EE/AE/JE hierarchy.',
  },
  {
    role: 'Admin',
    can: 'Support setup, inspect activity logs, verify pilot flow, help diagnose access issues, and monitor system/audit pages.',
    daily: 'Admin Activity Logs, Audit Logs, Enterprise pilot pages, setup verification pages.',
    review: 'Login/page activity, pilot events, assignment events, shared-login misuse, missing configuration, and blocked access.',
    ...
    <AppLayout title="NIRMAN AI User Manual" subtitle="Feature usage guide for EE, AE, JE, Contractor, and Admin users">
      ...
      <ManualCard id="login" title="3. First-Time Login Guide" icon={<Shield size={18} />}>
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          <BulletList
            items={[
              'Open the NIRMAN AI app link provided by ARSPL or your department pilot coordinator.',
              ...
              'If access is blocked, confirm that the correct account is used and that Vercel/app access is enabled for pilot users.',
            ]}
          />
      ...
      <ManualCard id="drive" title="12. Google Drive Document Ownership" icon={<FolderOpen size={18} />}>
        <BulletList
          items={[
            ...
            'Supabase should store metadata such as project ID, Drive file ID, uploader, document type, and timestamps.',
