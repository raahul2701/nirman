...
const routes: RouteObject[] = [
  ...
  { path: 'agreement-boq', element: <ProtectedRoute><OnboardingGuard><AgreementBoqStudyPage /></OnboardingGuard></ProtectedRoute> },
  ...
  { path: 'material-advance', element: <ProtectedRoute><OnboardingGuard><MaterialAdvancePage /></OnboardingGuard></ProtectedRoute> },
